...
def main():
    ...
    models = [
        ...
        {"name": "gemma3:12b", "temperature": 0}, # 12B (8.1GB)
    ...
    input_prompt = "You are a robot. Based on what you see, you must identify the object. You might see your robotic arm, but ignore it, focus on the object. After this: if the object should go in the personal items / electronics box (number 1), the cleaning box (number 2), or if the object is trash and should be thrown in the trash can (number 3). Be concise, identify the object, and you must categorize it in one of the three categories at all costs. Do not mention what it is not, identify what it is and its category."
    ...
    #     "Tools/Electronics": ["2", "tools"],
    #     "Trash": ["3", "trash", "rubbish", "dispos", "throw", "thrown"],
    #     "Unclear/Nothing": ["4", "unclear"]
    # }
    categories = {
        "Personal Items / Electronics": ["1", "personal", "electronics"],
        "Cleaning": ["2", "cleaning"],
        "Trash": ["3", "trash"],
        "Unclear/Nothing": ["4", "unclear"]
    }
